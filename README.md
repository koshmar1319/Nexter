...
<kbd> <img width="900" height="auto" align="center" alt="Превью проекта" src="./nexter_preview.jpg"> </kbd>

### Описание:
Проект по продаже престижной недвижимости.
...
>  В проекте активно используются `Flex`, `Grid`, `позиционирование`, `псевдоэлементы`, `псевдоклассы` и т.д.
...
```sh
git clone https://github.com/koshmar1319/Nexter.git
```
...
### Демо:
> Github Pages <br/>[Ссылка на сайт :arrow_lower_right:](https://koshmar1319.github.io/projects/Nexter/index.html "ссылка на сайт")
